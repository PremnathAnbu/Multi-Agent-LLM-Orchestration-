        ...
        stage('Cloning Github repo to Jenkins'){
            steps{
                script{
                    ...
                    checkout scmGit(branches: [[name: '*/main']], extensions: [], userRemoteConfigs: [[credentialsId: 'github-llm-token', url: 'https://github.com/PremnathAnbu/Multi-Agent-LLM-Orchestration-.git']])
